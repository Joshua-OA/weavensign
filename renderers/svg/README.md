...
dev_process/learning_v4.md #030). Because of that, and because SVG's fill/stroke are attributes on
...
rendering — see their READMEs and dev_process/learning_v4.md #031 for why), plus two specific to
this renderer:
