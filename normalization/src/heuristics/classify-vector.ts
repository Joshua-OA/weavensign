 ...
 * dev_process/learning_v3.md #024's deferred parent-context gap).
 */
 ...
 * flattened to one path by the time it reaches the API, see dev_process/learning_v2.md #021) — a
 ...
 * fallback (see dev_process/learning_v3.md #024) even though it's never real image content — it's
